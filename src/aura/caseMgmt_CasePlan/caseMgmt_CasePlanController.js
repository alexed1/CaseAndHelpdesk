({
    ...
    updateCaseStep : function(component,event,helper){
        ...
        if(!component.get("v.caseManager.listOfCaseSteps["+component.get("v.SelectedIndex")+"].Is_Pending__c")){
    ...
    startAssociateFlow : function(component, event, helper){
        ...
        if(event.getParam("status") === "FINISHED_SCREEN" || event.getParam("status") === "FINISHED") {
            ...
            if(isParentComplete){
                ...
                if(component.get("v.caseManager.listOfCaseSteps["+component.get("v.SelectedIndex")+"].Flow__c") != 'None' || component.get("v.caseManager.listOfCaseSteps["+component.get("v.SelectedIndex")+"].Flow__c") != null){
                    console.log('Flow Fired');
                     ...
                     flow.startFlow(component.get("v.caseManager.listOfCaseSteps["+component.get("v.SelectedIndex")+"].Flow__c"),inputVariables);
                ...
                var inputVariables = [
                    {
                       name : "CasePlanRecord",
                       type : "SObject",
                       value: component.get("v.caseManager.recordCasePlan")
                    },
                    {
                        name : "CaseStatusOrder",
                        type : "String",
                        value : component.get("v.caseManager.recordCasePlan.CaseStatusOrdering__c")
                    },
                    {
                      name : "Create",
                      type : "Boolean",
